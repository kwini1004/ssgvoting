   ...
   <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form">
                ...
                <label class="label">Partylist:</label>
                <input type="text" name="csymbol" id="" class="input" placeholder="Enter Partylist Name" required>

                <label class="label">Choose Partylist Image:</label>
